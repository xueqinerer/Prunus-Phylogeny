...
obj11 <- cophylo(MO_133, MI_133, rotate = TRUE)
obj12 <- cophylo(MO_133, orto_1to1_133,rotate = TRUE)
obj13 <- cophylo(orto_1to1_133, MI_133, rotate = TRUE)

pdf("Ortholog_MO_MI_1to1.pdf", height = 50, width = 34)
par(mfrow=c(2,2))
...
mtext("MO(5477 gene)", cex=3, side=2, line=-3, col="red")
...
mtext("1to1(3736 gene)", cex=3, side=2, line=-3, col="red")
mtext("MI(8316 gene)", cex=3, side=4, line=-1.5, col="red")
